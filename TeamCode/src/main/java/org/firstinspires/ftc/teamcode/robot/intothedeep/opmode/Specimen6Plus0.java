...
public class Specimen6Plus0 extends AbstractAuto {
    ...
    public static class ScoreSpecimens {
        public double
                ...
                // Timings
                waitBeforeVision = 0.5,
                waitBeforeDriveOffVison = 0.8,
                waitUntilExtendoRetracted = 0,
                ...
                sleepSecondsBeforeUnclampFirst = 1.7,
